...
@Table(name = "WRKCTPF", schema = "SBLIB", catalog = "")
public class WrkctpfEntity {
    ...
    public boolean equals(Object o) {
        ...
        WrkctpfEntity that = (WrkctpfEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(wrkct, wrkds, manto, manpo, cauph, caupm, tguph, tgupm, tgrat, fact, cust, sosk, nline, actgb, oldline, opgb, modi);
    }
}
